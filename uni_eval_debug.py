...
if __name__ == "__main__":
    ...
    # fire.Fire(eval)
    # If no CLI args are provided, use the following example flags (from the
    # commented example above) as the default command for Fire. Users can still
    # override by passing their own CLI args when invoking the script.
    fire.Fire(eval, command=[
        "--base_model", "Qwen/Qwen2.5-7B",
        "--chat_template_name", "default",
        "--system_prompt_name", "simplerl",
        "--output_dir", "result/eval/MATH/Qwen2.5-7B_debug",
        "--bf16", "True",
    ...
    # fire.Fire(eval, command=[
    #     "--base_model", "/hpc2hdd/home/xli026/project/DeepMath/outputs/qwen2.5-7b-deepmath-sft-R1/global_step_10/full_model",
    #     "--chat_template_name", "default",
    #     "--system_prompt_name", "simplerl",
    #     "--output_dir", "result/eval/MATH/Qwen2.5-7B-lora_debug",
    #     "--bf16", "True",
    #     "--tensor_parallel_size", "1",
    #     "--data_id", "zwhe99/MATH",
    #     "--split", "math500",
