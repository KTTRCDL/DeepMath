...
#SBATCH -o log/train/deepmath-qwen-2.5-7b-sft-R1-lora/output_%j.txt  # 指定作业标准输出文件，%j为作业号
#SBATCH -e log/train/deepmath-qwen-2.5-7b-sft-R1-lora/err_%j.txt    # 指定作业标准错误输出文件
...
SAVE_PATH=outputs/qwen2.5-7b-deepmath-sft-R1-lora
NPROC_PER_NODE=1
