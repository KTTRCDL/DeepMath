...
ray job submit --address="http://127.0.0.1:8265" \
    ...
    actor_rollout_ref.model.path=nvidia/OpenMath-Nemotron-1.5B \
    ...
    trainer.total_training_steps=700 2>&1 | tee -a $MODEL_DIR/$RUN_NAME/train.log
