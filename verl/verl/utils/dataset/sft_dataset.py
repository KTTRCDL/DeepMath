...
class SFTDataset(Dataset):
    ...
    def _read_files_and_tokenize(self):
        ...
        try:
            ...
            # If prompts is a DataFrame, extract the 'prompt' column
        ...
        try:
            ...
            # If responses is a DataFrame, extract the first response_key column
            self.responses = self.responses[self.response_key[0]].tolist()
